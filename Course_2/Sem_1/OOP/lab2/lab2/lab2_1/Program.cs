    ...
    public partial class Train
    {
        ...
        class Program
        {
            static void Main(string[] args)
            {
                ...
                Console.WriteLine(Belomer.ToString()); 
                ...
                Console.WriteLine($" \n | Иноформация о названии города {obj.City} | Номер поезда {obj.Numberoftrain} | Время отправления {obj.Gotime} | Число мест {obj.Numberofseats} \n | Число общих мест {obj.Common} | Число купешных мест {obj.Cope} | Число плацкартных мест {obj.Plackart} | Число люксовых мест {obj.Lux} |");
