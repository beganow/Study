...
Сценарий B – явную тран-закцию с уровнем изолиро-ванности READ COMMITED.
Сценарий A должен демон-стрировать отсутствие фан-томного, неподтвержденного и неповторяющегося чтения.
 */
 USE UNIVER;
