...
CREATE PROCEDURE PAUDITORIUM_INSERTX
		...
		@C INT = 0,
		@T CHAR(10),
		@TN VARCHAR(50)	--AUDITORIUM, AUDITORIUM_NAME, AUDI-TORIUM_CAPACITY и AUDITORIUM_TYPE, AUDITORIUM_TYPE.AUDITORIUM_TYPENAME 
AS BEGIN
DECLARE @RC INT = 1;
BEGIN TRY
...
DECLARE @K3 INT;
EXEC @K3 = PAUDITORIUM_INSERTX '102-3', @N = 'ЛК-К', @C = 85, @T = '102-3', @TN = 'Лекционная';
