...
select AUDITORIUM as 'јудитори€, свободные на 2 паре во вт'
from TIMETABLE
Where LESSON=2 AND DAY_NAME='вт'


select AUDITORIUM  as 'јудитори€, свободные не во вт'
from TIMETABLE
WHERE DAY_NAME <> 'вт'

select distinct AUDITORIUM.AUDITORIUM_NAME as 'јудитории свободные и на 2 паре и не во вт'
