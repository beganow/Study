...
 преобразование полного ФИО сту-дента в сокращенное (например, Ободов П.А);
...
SELECT @Z;
-------------------------------------------
DECLARE @LASTNAME NVARCHAR(20) = 'ОБОДОВ',
@FIRSTNAME NVARCHAR(20) = 'ПАВЕЛ',
@SURNAME NVARCHAR(20) = 'АНДРЕЕВИЧ',
