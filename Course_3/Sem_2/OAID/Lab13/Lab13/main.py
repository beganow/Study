...
scaler.fit(X_train)
X_train_scaled = (X_train - scaler.min_) / scaler.scale_
...
X_test_scaled = (X_test - scaler.min_) / scaler.scale_
...
axes[2].set_title("Неправильное масштабирование данных")
...
print("Правильность на масштабированном тестовомнаборе: {:.2f}".format(svm.score(X_test_scaled, y_test)))
